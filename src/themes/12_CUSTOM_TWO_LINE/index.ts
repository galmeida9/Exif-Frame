...
const CUSTOM_TWO_LINE_OPTIONS: ThemeOption[] = [
  ...
  { id: 'TEXT1', type: 'string', default: 'Your Text', description: 'ex. Hello, World!', elementId: 'text1' },
  { id: 'TEXT2', type: 'string', default: 'Your Text', description: 'ex. Hello, World!', elementId: 'text2' },
...
const CUSTOM_TWO_LINE_FUNC: ThemeFunc = (photo: Photo, input: ThemeOptionInput, store: Store, registry?: ElementRegistry) => {
