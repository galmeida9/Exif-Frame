...
const POSTER_OPTIONS: ThemeOption[] = [
  ...
  { id: 'TEXT1', type: 'string', default: '2001.01.01', elementId: 'text1' },
  { id: 'TEXT2', type: 'string', default: 'Lorem Ipsum', elementId: 'text2' },
  { id: 'TEXT3', type: 'string', default: 'dolor sit amet, consectetur', elementId: 'text3' },
  { id: 'TEXT4', type: 'string', default: 'White House', elementId: 'text4' },
  { id: 'TEXT5', type: 'string', default: '1600 Pennsylvania Avenue NW, Washington, DC 20500', elementId: 'text5' },
