...
const TIP_OPTIONS: ThemeOption[] = [
  ...
  { id: 'TAG', type: 'string', default: 'TIP', elementId: 'tag' },
  { id: 'TITLE', type: 'string', default: '01. Lorem ipsum', elementId: 'title' },
  { id: 'DESCRIPTION1', type: 'string', default: 'Pellentesque a pharetra justo', elementId: 'desc1' },
  { id: 'DESCRIPTION2', type: 'string', default: 'Nam maximus risus et rhoncus eleifend', elementId: 'desc2' },
